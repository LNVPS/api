...
pub trait AdminDb: Send + Sync {
    ...
    async fn admin_list_users(&self, limit: u64, offset: u64, search_pubkey: Option<&str>) -> Result<(Vec<crate::AdminUserInfo>, u64)>;
    
    // Region management methods
    /// List all regions with pagination
    async fn admin_list_regions(&self, limit: u64, offset: u64) -> Result<(Vec<crate::VmHostRegion>, u64)>;
    ...
    async fn admin_list_vm_os_images(&self, limit: u64, offset: u64) -> Result<(Vec<crate::VmOsImage>, u64)>;
    ...
    async fn list_vm_templates_paginated(&self, limit: i64, offset: i64) -> Result<(Vec<crate::VmTemplate>, i64)>;
    ...
    async fn admin_list_hosts_with_regions_paginated(&self, limit: u64, offset: u64) -> Result<(Vec<(crate::VmHost, crate::VmHostRegion)>, u64)>;
    ...
    async fn list_custom_templates_by_pricing_paginated(&self, pricing_id: u64, limit: i64, offset: i64) -> Result<(Vec<crate::VmCustomTemplate>, u64)>;
    ...
    async fn admin_list_companies(&self, limit: u64, offset: u64) -> Result<(Vec<crate::Company>, u64)>;
    ...
    async fn admin_get_payments_by_date_range(&self, start_date: chrono::DateTime<chrono::Utc>, end_date: chrono::DateTime<chrono::Utc>) -> Result<Vec<crate::VmPayment>>;
    ...
    async fn admin_list_access_policies_paginated(&self, limit: u64, offset: u64) -> Result<(Vec<crate::AccessPolicy>, u64)>;
    ...
    async fn admin_list_routers_paginated(&self, limit: u64, offset: u64) -> Result<(Vec<crate::Router>, u64)>;
